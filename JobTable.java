 ...
 * @author janet
 */
public class JobTable extends javax.swing.JInternalFrame {
    ...
    public JobTable() {
        initComponents();
        JFrame frame = new JFrame("Job Table");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        // Create JTable
        JTable tblJob = new JTable();

        // Create JScrollPane
        JScrollPane scrollPane = new JScrollPane(tblJob);
        ...
        // Populate the table
        populateTable(tblJob);
        
    }
    

    public static void populateTable(JTable tblJob) {
        // Get connection
        ...
        try {
            ...
            String query = "SELECT id, jobTitle, company, pay FROM job_table";
