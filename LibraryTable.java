 ...
 * @author janet
 */
public class LibraryTable extends javax.swing.JInternalFrame {
    ...
    public LibraryTable() {
        initComponents();
        JFrame frame = new JFrame("Hotel Table");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        // Create JTable
        JTable tblLibrary = new JTable();

        // Create JScrollPane
        JScrollPane scrollPane = new JScrollPane(tblLibrary);
        ...
        // Populate the table
        populateTable(tblLibrary);
        
    }
    

    public static void populateTable(JTable tblLibrary) {
        // Get connection
        ...
        try {
            ...
            String query = "SELECT id, libraryname, location, starrating FROM library_table";
