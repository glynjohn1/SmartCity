 ...
 * @author janet
 */
public class HotelTable extends javax.swing.JInternalFrame {
    ...
    public HotelTable() {
        ...
        // Create JTable
        JTable tblHotel = new JTable();

        // Create JScrollPane
        JScrollPane scrollPane = new JScrollPane(tblHotel);
        ...
        // Populate the table
        populateTable(tblHotel);
        
    }
    

    public static void populateTable(JTable tblHotel) {
        // Get connection
        ...
        try {
            ...
            String query = "SELECT id, hotelname, postcode, starrating FROM hotel_table";
